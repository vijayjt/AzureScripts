<#
    ...
    .EXAMPLE
        ...
        .\Get-AzureRBACRoleAssignments.ps1 -SubscriptionName 'MySubscriptionName' -AADTenantDomainName acme.com

        .\Get-AzureRBACRoleAssignments.ps1 -SubscriptionName 'MySubscriptionName' -OutputCSV -AADTenantDomainName acme.com

        .\Get-AzureRBACRoleAssignments.ps1 -AllSubscriptions -AADTenantDomainName acme.com

        .\Get-AzureRBACRoleAssignments.ps1 -AllSubscriptions -OutputCSV -AADTenantDomainName acme.com
